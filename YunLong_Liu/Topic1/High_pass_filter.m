...
% Design high pass filter 高通滤波器设计
filtOrdr = 30;
% 横轴频率空间范围 samplFreq/2
% 归一化 1/(samplFreq/2)
b = fir1(filtOrdr,(f2+f3)/2/(samplFreq/2),'high');
F0=figure;
freqz(b,1)
title('Highpass Filtered Design')
saveas(F0,'HighpassDesign.jpg');
% Apply filter
