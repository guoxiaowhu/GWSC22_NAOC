function outNoise = Whitencolgaussnoisegen(psdVals,fltrOrdr,sampFreq,colnoise)
%Generate a realization of stationary Gaussian noise with given 2-sided PSD
%Y = WHITENCOLGAUSSNOISEGEN(N,PSD,O,Fs,CN)
...
% rng('default'); 
outNoise = sqrt(sampFreq)*fftfilt(b,colnoise);
